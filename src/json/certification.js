...
const certificationsData = {
  "certifications": [
    ...
    },
    {
      ...
      "expiryDate": "",
      "credentialId": "5M9BW8GC5FH2",
      "credentialURL": "https://www.coursera.org/account/accomplishments/professional-cert/5M9BW8GC5FH2",
      "image": google_cys,
      "description": "Comprehensive professional certificate covering fundamentals of cybersecurity including security frameworks, network security, Linux, SQL, threat detection, and Python automation.",
      "skills": [
        "Python Programming",
      ...
      "subcourses": [
        {
          ...
          "description": "Introduction to cybersecurity concepts, frameworks, and historical context of information security."
        },
        {
          "id": "1-2",
          ...
          "description": "Learn about risk management frameworks, security audits, and incident response planning."
        },
        {
          "id": "1-3",
          ...
          "description": "Covers network architecture, security, TCP/IP protocols, and cloud network security."
        },
        {
          "id": "1-4",
          ...
          "description": "Hands-on experience with Linux command line interface, bash scripting, and SQL database queries."
        },
        {
          "id": "1-5",
          ...
          "description": "Focuses on asset classification, vulnerability assessment, authentication, and cryptography."
        },
        {
          "id": "1-6",
          ...
          "description": "Learn to use SIEM tools, packet analyzers, and intrusion detection systems."
        },
        {
          "id": "1-7",
          ...
          "description": "Apply Python programming to automate cybersecurity tasks using PEP 8 style guide."
        },
        {
          "id": "1-8",
